...
namespace BookTourOnline.Areas.Admin.Controllers
{
    public class FeedbacksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Email,Phone,Address,NoiDung,CreatedDate,Status")] Feedback feedback)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Email,Phone,Address,NoiDung,CreatedDate,Status")] Feedback feedback)
        {
            if (ModelState.IsValid)
            {
